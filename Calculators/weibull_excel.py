...
book = xlrd.open_workbook(r"Z:\Plains Midstream\2018_01_IRAS_Implementation\3_Engineering\Quantitative Risk Run (V6)\Results & QC\Corrosion CGR Analysis\ext-wb-fitting.xlsx")
end1 = time.time()
...
plt.title('Weibull Distribution Fitting for EXT CGR')
plt.xlabel('ln(CGR)')
